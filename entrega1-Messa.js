    ...
    switch (mtb) {
        case 1: alert((`Usted ha seleccionado la MTB roja de $100.000- 
            ...
            if (roja == 1) {
                ...
                precio = alert(`El costo de su MTB Roja es de 12 cuotas de  $${(mtbRoja * 1.1)/12}`)
            }
            break
        case 2: alert((`Usted ha seleccionado la MTB verde de $200.000- 
            ...
            if (verde == 1) {
                ...
                precio = alert(`El costo de su MTB Roja es de 12 cuotas de  $${(mtbVerde * 1.1)/12}`)
            }
            break
        case 3: alert((`Usted ha seleccionado la MTB Azul de $300.000- 
            ...
            if (azul == 1) {
                ...
                precio = alert(`El costo de su MTB Roja es de 12 cuotas de  $${(mtbAzul * 1.1)/12}`)
            }
            break
    }
}
